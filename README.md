...
- **Qwen-Image / Z-Image / Krea2（AT）子模式**：可分别选择画风、人物或概念训练。
...
3. 在左侧选择训练模式；Qwen-Image / Z-Image 再选择「人物」「画风」或「概念」。Qwen-Image 的 2512 / 2.1 版本在顶部「选择训练模型」里切换。
4. 按引导安装对应训练引擎；Qwen-Image / Z-Image 模型可在首次训练时自动下载，也可指定已有的完整模型目录。
