...
.train-dialog { display: flex; width: min(100%, 650px); max-height: min(84vh, 760px); flex-direction: column; gap: 11px; padding: 17px; border: 1px solid var(--tone-41464f); border-radius: 8px; background: var(--tone-272a32); box-shadow: 0 16px 44px rgb(0 0 0 / 34%); }
...
.train-state { display: flex; align-items: center; gap: 8px; min-height: 27px; color: var(--tone-b4bac4); font-size: 11px; }.train-state.completed { color: var(--tone-a8bea9); }.train-state.failed, .train-state.cancelled { color: var(--tone-c6a8aa); }.train-spinner { width: 13px; height: 13px; border: 1.5px solid var(--tone-515763); border-top-color: var(--tone-aeb5c0); border-radius: 50%; animation: train-spin .8s linear infinite; }.train-progress { height: 4px; overflow: hidden; border-radius: 5px; background: var(--tone-1d2026); }.train-progress > span { display: block; height: 100%; border-radius: inherit; background: var(--tone-75849a); transition: width 180ms ease; }.train-progress > span.indeterminate { width: 32%; animation: train-slide 1.2s ease-in-out infinite alternate; }.train-detail { margin: -5px 0 0; color: var(--tone-9299a4); font-size: 9px; }.train-log { min-height: 190px; max-height: 48vh; margin: 0; padding: 9px; overflow: auto; border: 1px solid var(--tone-393d47); border-radius: 5px; color: var(--tone-aeb4be); background: var(--tone-1d2026); font: 10px/1.5 Consolas, "Microsoft YaHei UI", sans-serif; white-space: pre-wrap; overflow-wrap: anywhere; user-select: text; }.train-log-line { min-height: 1.5em; white-space: pre-wrap; overflow-wrap: anywhere; }.tone-default { color: var(--tone-aeb4be); }.tone-muted { color: var(--tone-858c98); }.tone-warning { color: var(--tone-d4b06a); }.tone-error { color: var(--tone-e08a8a); }.tone-success { color: var(--tone-9ecb8f); }.tone-training { color: var(--tone-8fb0c9); }.tone-info { color: var(--tone-8fa8d4); }.log-emphasis { color: inherit; font-weight: 600; }
...
.train-actions { display: flex; justify-content: flex-end; gap: 7px; margin-top: 2px; }.train-button { min-height: 30px; padding: 0 10px; border: 1px solid var(--tone-3d424b); border-radius: 5px; color: var(--tone-b8bdc6); background: transparent; font-size: 10px; cursor: pointer; }.train-button:hover:not(:disabled) { border-color: var(--tone-555c68); background: var(--tone-2e323a); }.train-button.primary { border-color: transparent; color: var(--tone-eff0f2); background: var(--tone-626f81); }.train-button:disabled { opacity: .55; cursor: wait; }
