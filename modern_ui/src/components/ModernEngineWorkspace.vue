...
<template>
  <section class="engine-workspace" :aria-label="`${details.label} 训练工作区`">
    ...
    <div class="engine-scroll-area">
      <div class="engine-scroll-content">
        ...
        <p v-if="desktop" class="engine-footer-note"><i></i>训练与预处理直接调用当前模式原有引擎；运行状态、日志和停止操作都在现代界面内。</p>
...
.engine-toolbar{display:flex;flex:0 0 auto;align-items:center;justify-content:space-between;gap:14px;min-height:58px;padding:9px 24px 7px;border-bottom:1px solid rgb(255 255 255 / 2.5%)}
.engine-heading,.engine-heading-copy,.engine-actions{display:flex;align-items:center}.engine-heading{gap:15px;min-width:0}.engine-heading-copy{gap:11px;min-width:0}.engine-heading-copy h1{margin:0;color:#d1d4da;font-size:17px;font-weight:350;white-space:nowrap}.engine-heading-copy span{overflow:hidden;color:var(--hint);font-size:11px;text-overflow:ellipsis;white-space:nowrap}.engine-actions{gap:7px}.engine-update-button{display:inline-flex;align-items:center;gap:6px;min-height:31px;padding:0 10px;border:1px solid #827047;border-radius:5px;color:#d3bd8b;background:#302c22;font-size:10px;white-space:nowrap;cursor:pointer;transition:background-color 140ms ease,border-color 140ms ease}.engine-update-button:hover{border-color:#a18a59;background:#393326}.update-arrow{display:inline-block;animation:update-arrow-pulse 900ms ease-in-out infinite alternate}@keyframes update-arrow-pulse{from{transform:translateY(2px) rotate(-10deg);opacity:.68}to{transform:translateY(-2px) rotate(8deg);opacity:1}}
.engine-button,.engine-back{display:inline-flex;align-items:center;justify-content:center;gap:6px;min-height:31px;padding:0 10px;border:1px solid var(--border);border-radius:5px;color:#b3bac4;background:transparent;font-size:11px;white-space:nowrap;cursor:pointer;transition:background-color 140ms ease,border-color 140ms ease,color 140ms ease,transform 120ms var(--ease-out)}.engine-button:hover,.engine-back:hover{border-color:#505660;color:#d2d5db;background:#292c34}.engine-button:active,.engine-back:active{transform:scale(.985)}.engine-button .ui-icon,.engine-back .ui-icon{width:13px;height:13px}.engine-button.primary{border-color:transparent;color:#e5e7eb;background:#626f81}.engine-button.primary:hover{background:#6b7788}.engine-button.compact{min-height:28px;padding:0 9px;font-size:10px}
.engine-status-line{display:flex;align-items:center;gap:7px;min-height:36px;padding:3px 24px 6px}.engine-status{display:inline-flex;align-items:center;min-height:22px;padding:0 8px;border:1px solid #3b3e46;border-radius:4px;color:#a9aeb6;background:#262930;font-size:10px}.engine-status.ready{color:#aab8ad}.engine-link{padding:3px 2px;border:0;color:#adb6c2;background:transparent;font-size:10px;cursor:pointer}.engine-link:hover{color:#d1d5dc;text-decoration:underline}
.engine-scroll-area{flex:1;min-height:0;overflow:auto;scrollbar-color:#4a4e56 transparent;scrollbar-width:thin}.engine-scroll-content{display:flex;flex-direction:column;gap:10px;padding:5px 25px 13px 24px}.engine-summary,.engine-card{min-width:0;border:1px solid rgb(255 255 255 / 2%);border-radius:7px;background:var(--card)}.engine-summary{display:grid;grid-template-columns:minmax(0,1.2fr) auto minmax(0,1fr) auto;align-items:center;gap:10px;padding:10px 12px}.summary-main,.asset-copy{display:grid;min-width:0;gap:4px}.summary-label,.engine-field>span{color:var(--hint);font-size:10px}.summary-main strong,.asset-copy strong{overflow:hidden;color:#c5cad1;font-size:11px;font-weight:350;text-overflow:ellipsis;white-space:nowrap}.summary-main small,.asset-copy small{overflow:hidden;color:#888e97;font-size:9px;line-height:1.4;text-overflow:ellipsis}.engine-card-grid{display:grid;grid-template-columns:minmax(0,1fr) minmax(0,1fr);gap:10px}.engine-card{padding:12px 13px 11px}.engine-card-heading{display:flex;align-items:center;gap:9px;min-height:25px;margin-bottom:10px}.engine-card-heading>span{color:#8993a0;font-size:10px;letter-spacing:.04em}.engine-card-heading>div{display:grid;gap:2px}.engine-card-heading h2{margin:0;color:#cbd0d7;font-size:13px;font-weight:400}.engine-card-heading small{color:var(--hint);font-size:9px}
.engine-fields{display:grid;gap:9px}.engine-fields.two-columns{grid-template-columns:repeat(2,minmax(0,1fr))}.engine-fields.spaced{margin-top:9px}.engine-field{display:grid;min-width:0;gap:5px}.engine-input,.engine-select{width:100%;min-width:0;height:30px;padding:0 9px;border:1px solid #3d414a;border-radius:5px;color:#c6cbd3;background:#22252c;font-size:11px;font-weight:350}.engine-select{padding-right:24px;cursor:pointer}.engine-select option{color:#cbd0d7;background:#252830}.engine-input::placeholder{color:#707680}.engine-param-grid{display:grid;grid-template-columns:repeat(4,minmax(82px,1fr));gap:8px}.engine-hint{margin:8px 0 0;color:#898f99;font-size:10px;line-height:1.45;white-space:pre-line}
.engine-switch{display:flex;align-items:center;gap:8px;width:100%;margin-top:8px;padding:4px 0;border:0;color:inherit;background:transparent;text-align:left;cursor:pointer}.engine-switch>i{position:relative;width:27px;height:15px;flex:0 0 auto;border-radius:9px;background:#454951;transition:background-color 150ms ease}.engine-switch>i:after{position:absolute;top:2px;left:2px;width:11px;height:11px;border-radius:50%;background:#adb3bc;transition:transform 160ms var(--ease-out);content:''}.engine-switch.active>i{background:#626f81}.engine-switch.active>i:after{transform:translateX(12px)}.engine-switch>span{display:grid;gap:2px}.engine-switch strong{color:#bfc4cc;font-size:11px;font-weight:400}.engine-switch small{color:var(--hint);font-size:9px}.engine-check{display:inline-flex;align-items:center;gap:7px;min-height:28px;padding:2px 3px;border:0;color:#a7adb7;background:transparent;font-size:10px;text-align:left;cursor:pointer}.engine-check>i{display:grid;width:14px;height:14px;flex:0 0 auto;place-items:center;border:1px solid #646a75;border-radius:3px;background:#22252c;transition:border-color 130ms ease,background-color 130ms ease}.engine-check.checked>i{border-color:#687689;background:#626f81}.engine-check.checked>i:after{width:6px;height:3px;border-bottom:1.4px solid #e2e5e9;border-left:1.4px solid #e2e5e9;transform:translateY(-1px) rotate(-45deg);content:''}.engine-check:hover{color:#d0d4da}
.advanced-heading{margin-bottom:9px}.engine-advanced-grid{display:grid;grid-template-columns:repeat(4,minmax(100px,1fr));align-items:end;gap:9px}.wide-field{grid-column:span 2}.engine-utility-row{display:flex;flex-wrap:wrap;gap:7px}.engine-utility{min-height:29px;padding:0 10px;border:1px solid var(--border);border-radius:5px;color:#afb5bf;background:#252830;font-size:10px;cursor:pointer;transition:border-color 130ms ease,color 130ms ease,background-color 130ms ease,transform 110ms ease-out}.engine-utility:hover{border-color:#505660;color:#d0d4da;background:#2b2e36}.engine-utility:active{transform:scale(.985)}.engine-footer-note{display:flex;align-items:center;gap:7px;margin:-2px 1px 0;color:#818792;font-size:10px}.engine-footer-note i{width:5px;height:5px;border-radius:50%;background:#929baa}
